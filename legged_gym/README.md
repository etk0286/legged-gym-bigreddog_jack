...
```
    ...
    example
    python legged_gym/scripts/play_him.py --task=big_reddog_him_jack --load_run=Oct02_09-52-29_ --checkpoint=10000
    python legged_gym/scripts/train.py --task=big_reddog_him_jack``
```
